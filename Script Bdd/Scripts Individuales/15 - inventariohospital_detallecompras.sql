...
CREATE TABLE `detallecompras` (
  ...
  `DtcCantidadIngresada` int NOT NULL,
  `DtcCantidadDevuelta` int NOT NULL,
  `DtctTieneImpuesto` varchar(5) NOT NULL,
  `DtcPrecioCompra` decimal(9,2) NOT NULL,
  PRIMARY KEY (`CmpId`,`InvPrdId`)
