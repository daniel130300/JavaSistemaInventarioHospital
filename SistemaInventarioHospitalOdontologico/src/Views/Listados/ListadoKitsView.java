 ...
 * @author usuario
 */
public class ListadoKitsView extends javax.swing.JFrame {
    
    /**
     * Creates new form ListadoKitsView
     */
    public ListadoKitsView() {
        initComponents();
        KitController.LlenarTableKit(tableKits, "Activos");
    ...
    private void initComponents() {
        ...
        lblModulo.setText("Listado de Kits");
        pnlTitulo.add(lblModulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, 220, 30));
        ...
        tableKits.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Kit", "Nombre", "Descripción", "Estado"
            }
        ) {
        ...
        pnlMenu.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 710, 440));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(pnlTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 605, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(pnlMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 809, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
    ...
    private void tableKitsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableKitsMouseClicked
        ...
        InventarioPadreController.AddNombreKit(new Object[]{
                Integer.parseInt(String.valueOf(this.tableKits.getModel().getValueAt(seleccion, 0))),
                String.valueOf(this.tableKits.getModel().getValueAt(seleccion, 1)),
                String.valueOf(this.tableKits.getModel().getValueAt(seleccion, 2))
            });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoKitsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoKitsView().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tableKits;
