 ...
 * @author usuario
 */
public class ListadoUnidadesView extends javax.swing.JFrame {
    
    /**
     * Creates new form ListadoUnidades
     */
    public ListadoUnidadesView() {
        initComponents();
        UnidadesController.LlenarTableUnidades(tableUnidades, "Activos");
        UnidadesController.FiltroTableUnidades(tableUnidades, txtBuscar);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoUnidadesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoUnidadesView().setVisible(true);
            }
        });
    }
