...
import Controllers.Controllers.MenuProveedoresController;
 ...
 * @author danie
 */
public class MenuProveedoresView extends javax.swing.JFrame {

    /**
     * Creates new form LoginView
     */
    public MenuProveedoresView() {
        initComponents();
        noFocusJButtons();
        LoginController.setLabelUsrLogueado(this.lblUsuarioActual);
        MenuProveedoresController menuProveedoresController = new MenuProveedoresController();
        menuProveedoresController.AccesoModulos(this.btnMantenimientoProveedores, 
            this.btnMantenimientoRubros);
    }
    
    private void noFocusJButtons()
    {
        this.btnMantenimientoProveedores.setFocusable(false);
        this.btnMantenimientoRubros.setFocusable(false);
    }
    ...
    private void initComponents() {
        ...
        btnMantenimientoRubros = new javax.swing.JButton();
        ...
        btnMantenimientoRubros.setBackground(new java.awt.Color(45, 83, 150));
        btnMantenimientoRubros.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnMantenimientoRubros.setForeground(new java.awt.Color(242, 242, 242));
        btnMantenimientoRubros.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/Images/icons8_business_24px.png"))); // NOI18N
        btnMantenimientoRubros.setText("Mantenimiento Rubros");
        btnMantenimientoRubros.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnMantenimientoRubros.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnMantenimientoRubros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMantenimientoRubrosActionPerformed(evt);
            }
        });
        pnlMenu.add(btnMantenimientoRubros, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, 180, 130));

        btnMantenimientoProveedores.setBackground(new java.awt.Color(45, 83, 150));
        btnMantenimientoProveedores.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnMantenimientoProveedores.setForeground(new java.awt.Color(242, 242, 242));
        btnMantenimientoProveedores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/Images/icons8_supplier_32px.png"))); // NOI18N
        btnMantenimientoProveedores.setText("Mantenimiento Proveedores");
        btnMantenimientoProveedores.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnMantenimientoProveedores.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        ...
        pnlMenu.add(btnMantenimientoProveedores, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 180, 130));
        ...
        lblModulo.setText("Menú Proveedores");
    ...
    private void btnMantenimientoRubrosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMantenimientoRubrosActionPerformed
        MantenimientoRubrosView mantenimientoRubrosView = new MantenimientoRubrosView();
        mantenimientoRubrosView.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnMantenimientoRubrosActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuProveedoresView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuProveedoresView().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnMantenimientoRubros;
