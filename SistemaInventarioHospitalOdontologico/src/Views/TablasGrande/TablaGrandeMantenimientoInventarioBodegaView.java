...
public class TablaGrandeMantenimientoInventarioBodegaView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlMenu.add(lblBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));
        ...
        pnlMenu.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, 520, -1));
        ...
        pnlMenu.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 1020, 390));
    ...
    private void tableBodegaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableBodegaMouseClicked
        ...
        inventario.setUndDescripcion(String.valueOf(this.tableBodega.getModel().getValueAt(seleccion, 5)));
        inventario.setKitNombre(InventarioPadreConexion.getNombreKit(Integer.parseInt(this.tableBodega.getModel().getValueAt(seleccion, 6).toString())));
        inventario.setPrdNombre(InventarioPadreConexion.getNombreProducto(Integer.parseInt(this.tableBodega.getModel().getValueAt(seleccion, 8).toString())));
        InventarioPadreCache inventarioCache = new InventarioPadreCache();
