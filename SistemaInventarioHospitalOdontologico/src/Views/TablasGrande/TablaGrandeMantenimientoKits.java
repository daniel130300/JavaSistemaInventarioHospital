 ...
 * @author danie
 */
public class TablaGrandeMantenimientoKits extends javax.swing.JFrame {

    /**
     * Creates new form LoginView
     */
    public TablaGrandeMantenimientoKits() 
    {
        initComponents();
    ...
    private void rbnInactivosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbnInactivosActionPerformed
        KitController.LlenarTableKit(tableKits, "Inactivos");
        rbnActivos.setSelected(false);
        rbnTodos.setSelected(false);
    ...
    private void tableKitsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableKitsMouseClicked
        ...
        kit.setKitId(Integer.parseInt(String.valueOf(this.tableKits.getModel().getValueAt(seleccion, 0))));
        kit.setKitNombre(String.valueOf(this.tableKits.getModel().getValueAt(seleccion, 1)));
        kit.setKitDescripcion(String.valueOf(this.tableKits.getModel().getValueAt(seleccion, 2)));
        kit.setKitEstado(estados.getValueEstado(String.valueOf(this.tableKits.getModel().getValueAt(seleccion,3))));
        kitCache kcache = new kitCache();
        kcache.setDatosCompartidos(true);
        kcache.setKit(kit);
        MantenimientoKitsView mantenimientoKitsView = new MantenimientoKitsView();
        mantenimientoKitsView.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaGrandeMantenimientoKits.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaGrandeMantenimientoKits().setVisible(true);
            }
        });
    }
