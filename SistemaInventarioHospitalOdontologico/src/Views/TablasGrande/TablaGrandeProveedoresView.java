 ...
 * @author danie
 */
public class TablaGrandeProveedoresView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblModulo.setText("Búsqueda Proveedores");
        ...
        tableProveedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id proveedor", "Registro Sanitario", "RTN", "Nombre", "Correo", "Telefono", "Direccion", "Estado"
            }
        ) {
    ...
    private void tableProveedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableProveedoresMouseClicked
        ...
        proveedorModel.setProEstado(String.valueOf(this.tableProveedores.getModel().getValueAt(seleccion,7))); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaGrandeProveedoresView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaGrandeProveedoresView().setVisible(true);
            }
        });
    }
