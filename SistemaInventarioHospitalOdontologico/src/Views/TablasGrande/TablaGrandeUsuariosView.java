 ...
 * @author danie
 */
public class TablaGrandeUsuariosView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblModulo.setText("Búsqueda Usuarios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaGrandeUsuariosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaGrandeUsuariosView().setVisible(true);
            }
        });
    }
